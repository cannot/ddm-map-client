    ...
    <div class="flex h-full z-[1]">
      <div class="w-1/5 md:w-1/5 m-3">
        <div class="relative flex-1 md:min-w-[350px]">
          ...
          <label for="jobid">วันที่ข้อมูล:</label>
          <input class="pl-9 pr-4 py-3 text-[14px] focus:outline-none w-full shadow-md rounded-md my-2" type="text"
            v-model="beginDate" />

          <label for="jobid">ถึง:</label>
          <input class="pl-9 pr-4 py-3 text-[14px] focus:outline-none w-full shadow-md rounded-md my-2" type="text"
            v-model="endDate" />

          <p>ประเภทข้อมูล:</p>

          <input type="radio" id="radio-1" name="displayType" value="1">
          <label for="radio-1" class="pl-9 pr-4 py-3 text-[14px]  w-full my-1">เฉลี่ย On Peak</label><br>

          <input type="radio" id="radio-2" name="displayType" value="2">
          <label for="radio-2" class="pl-9 pr-4 py-3 text-[14px]  w-full my-1">เฉลี่ย Off Peak</label><br>

          <input type="radio" id="radio-3" name="displayType" value="3">
          <label for="radio-3" class="pl-9 pr-4 py-3 text-[14px]  w-full my-1">เฉลี่ย 24 ชั่วโมง</label><br>
    ...
    const search = () => {
      ...
      queryTimeout.value = setTimeout(async () => {
        ...
        if (searchQuery.value !== "") {
          ...
          const data = await axios.get(`http://localhost:3000/api/search/p275/p275?${params}`);
